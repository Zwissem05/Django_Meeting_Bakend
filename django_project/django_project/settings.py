...
SECRET_KEY = 'django-insecure-u1!jdd$#8zyh9e%sful!_r_nbdbkys@w50t$tk&-1spw9!skc9'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # Gardez SessionAuthentication si vous voulez tester via l'interface web de DRF
